      ...
      <div class="row">
        ...
        <div class="col-lg-8 entries">
          ...
          <article class="entry entry-single">
            ...
            <div class="entry-img">
              <img src="{{ asset('backend/img/pemerintah-desa/visi-misi/' . '/' . $visiMisi->cover) }}" alt="" class="img-fluid">
            </div>

            <h2 class="entry-title">
              <a href="#">Visi Misi Desa Kutorenon</a>
            </h2>

            <div class="entry-meta">
              <ul>
                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">Administrator</a></li>
                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time>{{date('d-m-Y', strtotime($visiMisi->created_at))}}</time></a></li>
