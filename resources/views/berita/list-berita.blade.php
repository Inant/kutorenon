            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                    <form action="{{ route('berita.index') }}" class="navbar-search navbar-search-light" id="navbar-search-main">
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              <a class="dropdown-item" href="{{ route('berita.edit', $value->id) }}">Edit</a>
