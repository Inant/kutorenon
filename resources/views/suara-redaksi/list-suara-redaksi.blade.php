    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                    <form action="{{ route('suara-redaksi.index') }}" class="navbar-search navbar-search-light" id="navbar-search-main">
            ...
            <div class="table-responsive">
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              <a class="dropdown-item" href="{{ route('suara-redaksi.edit', $value->id) }}">Edit</a>
                              {{-- fitur delete sementara nonaktif --}}
                              <form action="{{ route('suara-redaksi.destroy', $value->id) }}" method="post">
                                @csrf
                                @method('delete')
              ...
              {{$suaraRedaksi->appends(Request::all())->links()}}
            </div>
         </div>
    </div>
</div>
