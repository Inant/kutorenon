    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                    <form action="{{ url('administrator/pengaduan') }}" class="navbar-search navbar-search-light" id="navbar-search-main">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="name">Keluhan</th>
                    <th scope="col"></th>
                  </tr>
                </thead>
                <tbody class="list">
                  ...
                  @foreach ($pengaduan as $value)
                      <tr>
                        ...
                        <td>{{implode(' ', array_slice(explode(' ', $value->keluhan), 0, 5))}}...</td>
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              <a class="dropdown-item" href="{{ route('show-pengaduan', $value->id) }}">Detail</a>
              ...
              {{$pengaduan->appends(Request::all())->links()}}
            </div>
         </div>
    </div>
</div>
