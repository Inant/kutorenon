        ...
        <div class="card">
            ...
            <form action="{{ route('bpd.update', $bpd->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  ...
                  <br>
                  <img src="{{ asset('backend/img/pemerintah-desa/bpd/'.$bpd->cover) }}" alt="" width="500px">
                  <br>
                    <span>
                  ...
                  <textarea name="konten" id="editor" class="form-control @error('konten') is-invalid @enderror">{{old('konten', $bpd->konten)}}</textarea>
                  @error('konten')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
