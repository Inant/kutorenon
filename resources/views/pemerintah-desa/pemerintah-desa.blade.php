        ...
        <div class="card">
            ...
            <form action="{{ route('pemerintah-desa.update', $pemerintahDesa->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  ...
                  <br>
                  <img src="{{ asset('backend/img/pemerintah-desa/pemerintah-desa/'.$pemerintahDesa->cover) }}" alt="" width="500px">
                  <br>
                    <span>
                  ...
                  <textarea name="konten" id="editor" class="form-control @error('konten') is-invalid @enderror">{{old('konten', $pemerintahDesa->konten)}}</textarea>
                  @error('konten')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
