...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('backend/backend/img/brand/favicon.png') }}" type="image/png">
    <!-- Fonts -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Website Desa Kutorenon</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            {{-- <div class="card-header bg-transparent p3-5 text-center">
                <img src="{{ asset('backend/img/logobaratha.png') }}" class="navbar-brand-img" alt="..." width="100px">
            </div> --}}
