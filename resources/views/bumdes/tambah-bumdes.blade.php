        ...
        <div class="card">
            ...
            <form action="{{ route('bumdes.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  ...
                  <input type="text" name="nama" value="{{old('nama')}}" class="form-control @error('nama') is-invalid @enderror" placeholder="ex : Jaya Mandiri">
                  @error('nama')
                  ...
                  <input type="text" name="ketua_unit" value="{{old('ketua_unit')}}" class="form-control @error('ketua_unit') is-invalid @enderror" placeholder="ex : Lebron James">
                  @error('ketua_unit')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
